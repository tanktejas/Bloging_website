const apifortechblog = [
  {
    title: "Web Technology",
    path: "/blogs/techblog/webblog",
    Summary:
      "You probably know that computers don't communicate with each other the way that people do. Instead, computers require codes, or directions.....",
  },
  {
  ...
  },
  {
    ...
    Summary:
      "Cloud computing is the delivery of different services through the Internet, including data storage, servers, databases, networking, and software. Cloud-based storage makes it",
  },
  {
  ...
  },
  {
    ...
    Summary:
      "The Internet of Things (IoT) describes the network of physical objects—“things”—that are embedded with sensors, software, and other technologies for the ...",
  },
];

export default apifortechblog;
